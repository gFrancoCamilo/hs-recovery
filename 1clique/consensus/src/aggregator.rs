...
impl Aggregator {
    ...
    pub fn add_vote(&mut self, vote: Vote, threshold: u32) -> ConsensusResult<Option<QC>> {
        ...
        self.votes_aggregators
            ...
            .append(vote, &self.committee, threshold)
    }

    pub fn add_timeout(&mut self, timeout: Timeout, threshold: u32) -> ConsensusResult<Option<TC>> {
        ...
        self.timeouts_aggregators
            ...
            .append(timeout, &self.committee, threshold)
    }
...
impl QCMaker {
    ...
    pub fn append(&mut self, vote: Vote, committee: &Committee, threshold: u32) -> ConsensusResult<Option<QC>> {
        ...
        if self.weight >= threshold {//committee.quorum_threshold() {
