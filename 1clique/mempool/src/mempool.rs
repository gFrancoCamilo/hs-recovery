...
impl Mempool {
    ...
    fn handle_consensus_messages(&self, rx_consensus: Receiver<ConsensusMempoolMessage>, network_delay: u64) {
    ...
    fn handle_mempool_messages(&self, network_delay: u64) {
