...
pub struct Block {
  ...
  //  pub identified_faults: Vec<SocketAddr>,
...
impl Block {
    pub async fn new(
        ...
        author: PublicKey,
        round: Round,
//        identfied_faults: Vec<SocketAddr>,
        payload: Vec<Digest>,
...
pub struct FirstBlocks {
    pub sender: PublicKey,
    pub blocks: Vec<Block>,
    pub clique: Vec<SocketAddr>,
}

#[derive(Clone, Serialize, Deserialize)]
pub struct IdentifyFaults {
    pub sender: PublicKey,
}
